...
if (isset($_POST['add'])) {
    ...
    $conn->query("INSERT INTO room_210  (subject, start_time, end_time, block, professor, day, password) VALUES ('$subject', '$start_time', '$end_time', '$block', '$day', '$professor', '$password')");
...
if (isset($_POST['update'])) {
    ...
    $day = $_POST['day'];
    $password = $_POST['password'];
    $conn->query("UPDATE room_210 SET block='$block', professor='$professor', start_time='$start_time', end_time='$end_time', subject='$subject', day='$day', password='$password' WHERE id=$id");
...
if (isset($_GET['delete'])) {
    $id = $_GET['delete'];
    $conn->query("DELETE FROM room_210 WHERE id=$id");
}

$fullname = $_SESSION['fullname'];
// READ
$result = $conn->query("SELECT * FROM room_210 WHERE professor = '$fullname' ORDER BY start_time ASC");
...
<body>
    ...
    <div class="main-content">
        <div class="container">
            <div class="panel">
                <h2 class="mb-4 text-secondary"><i class="bi bi-robot me-2"></i>room 210</h2>
