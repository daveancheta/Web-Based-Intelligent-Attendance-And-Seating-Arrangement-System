...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("SELECT fullname FROM teacher_accounts WHERE email = ? AND password = ?");
    ...
    if ($result->num_rows > 0) {
        ...
        $check_email = $conn->prepare("SELECT fullname FROM teacher_accounts WHERE email = ?");
...
<body>
    ...
    <?php endif; ?>
                <div class="form-floating mb-3">
                    <input class="form-control" type="email" id="t-email" name="t-email" placeholder="EMAIL" required autocomplete="off" value="<?php echo htmlspecialchars($_SESSION['email'] ?? ''); ?>">
