...
$student_number = $_SESSION['fullname'];

// Validate student
$stmt = $conn->prepare("SELECT fullname FROM teacher_accounts WHERE fullname = ?");
...
if ($result->num_rows > 0) {
    ...
    $student_number = htmlspecialchars($user_data['fullname'], ENT_QUOTES, 'UTF-8');
} else {
