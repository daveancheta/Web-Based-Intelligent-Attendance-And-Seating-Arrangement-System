...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['email'])) {
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        $sql = "SELECT email, password FROM data_student WHERE email = ? LIMIT 1";
        ...
        if (!$stmt) {
            ...
            if ($result->num_rows > 0) {
                ...
                try {
                    ...
                    $mail->SMTPAuth = true;
                    $mail->Username = $_SERVER['EMAIL_USER'] ?? 'default@email.com'; // Fallback if env var not set
                    ...
                    // Email content
                    $mail->isHTML(true);
                    $mail->Subject = 'Your Password - National Teachers College';
                    $mail->Body = '
                    <html>
                    <head>
                        <style>
                    ...
                    <body>
                        <div class="container">
                            ...
                            <div class="info-box">
                                ...
                                <p style="font-size: 24px; font-weight: bold; color: #272bae;">' . $password . '</p>
...
<body>
    ...
    <div class="overlay"></div>
        <div class="form-container">
            ...
            <h2 class="fs-5 mt-3 mb-3">Password Recovery</h2>
            ...
            <form method="POST" action="">
                ...
                <button class="btn-color mt-3 mb-4" type="submit" name="submit">Recover Password</button>
            </form>
    ...
    <script>
        ...
        if (performance.navigation.type == 1) {
            window.location.href = '18-forgot-password.php';
        }
    </script>
</body>
