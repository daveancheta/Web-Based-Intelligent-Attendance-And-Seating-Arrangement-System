...
if (isset($_POST['add'])) {
    ...
    $conn->query("INSERT INTO rooms (name, password) VALUES ('$name', '$password')");
...
if (isset($_POST['update'])) {
  ...
  $password = !empty($_POST['password']) ? password_hash($_POST['password'], PASSWORD_DEFAULT) : NULL;
    ...
    $conn->query("UPDATE rooms SET name='$name', password='$password' WHERE id=$id");
...
<body>
   ...
   <div class="container">
    <div class="panel">
        <h2 class="mb-4 text-secondary">Chat Room</h2>
