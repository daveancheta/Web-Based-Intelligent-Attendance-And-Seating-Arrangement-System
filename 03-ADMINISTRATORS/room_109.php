...
if (isset($_POST['add'])) {
    ...
    $day = $_POST['day'];
    $conn->query("INSERT INTO room_109  (subject, start_time, end_time, block, professor, day) VALUES ('$subject', '$start_time', '$end_time', '$block', '$day', '$professor')");
...
if (isset($_POST['update'])) {
    ...
    $subject = $_POST['subject'];
    $day = $_POST['day'];
    $conn->query("UPDATE room_109 SET block='$block', professor='$professor', start_time='$start_time', end_time='$end_time', subject='$subject', day='$day' WHERE id=$id");
...
// READ
$result = $conn->query("SELECT * FROM room_109");
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
         <p id="qr-value" class="fw-bold text-muted"></p> <!-- Display the value here -->
