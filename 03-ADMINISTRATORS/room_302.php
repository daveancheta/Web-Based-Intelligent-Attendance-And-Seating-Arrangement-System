...
if (isset($_POST['add'])) {
    ...
    $day = $_POST['day'];
    $conn->query("INSERT INTO room_302  (subject, start_time, end_time, block, professor, day) VALUES ('$subject', '$start_time', '$end_time', '$block', '$day', '$professor')");
...
if (isset($_POST['update'])) {
    ...
    $subject = $_POST['subject'];
    $day = $_POST['day'];
    $conn->query("UPDATE room_302 SET block='$block', professor='$professor', start_time='$start_time', end_time='$end_time', subject='$subject', day='$day' WHERE id=$id");
...
// READ
$result = $conn->query("SELECT * FROM room_302");
?>
<!DOCTYPE html>
<html lang="en">
